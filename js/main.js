...
const products = [
    ...
    // Диз. компрессоры
    { category: 'diesel', name: 'DAC-X3.5/7', description: 'Серия DAC - Дизельные, мобильные винтовые компрессоры с прямым приводом', image: 'assets/img/Модель_DA_5D.jpeg' },
    { category: 'diesel', name: 'DAC-X5/7', description: 'Серия DAC - Дизельные, мобильные винтовые компрессоры с прямым приводом', image: 'assets/img/Модель_DA_5D.jpeg' },
    { category: 'diesel', name: 'DAC-X10/7', description: 'Серия DAC - Дизельные, мобильные винтовые компрессоры с прямым приводом', image: 'assets/img/Модель_DA_5D.jpeg' },
    { category: 'diesel', name: 'DAC-X12/12', description: 'Серия DAC - Дизельные, мобильные винтовые компрессоры с прямым приводом', image: 'assets/img/Модель_DA_5D.jpeg' },
];
